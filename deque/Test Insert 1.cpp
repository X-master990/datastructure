...
#include <deque>
#include "1111514 - deque - insert.h"
   ...
   if( mapSize2 == 0 )
      if( mySize2 == 0 && myOff2 == 0 && map2 == nullptr )
         return true;
          ...
          cout << "map pointer error" << endl;
          return false;
      }
   if (myOff1 != myOff2) {
       cout << myOff1 << "and" << myOff2 << endl;
       cout << "myoff errors" << endl;
       return false;
   }
   if (mySize1 != mySize2) {
       cout << "mysize errors" << endl;
       return false;
   }
   size_t dequeSize = compDequeSize< T >(); // elements per block (a power of 2)
